...
import { Box, Grid, Typography, Drawer,Button ,Card,CardContent,CardMedia} from '@mui/material';
...
function MyApp() {
  ...
  return (
    <Box sx={{ display: 'flex', flexDirection: 'column', height: '2000', bgcolor: '#f5f8fb', color: '#000000' }}>
      ...
      <Box sx={{ display: 'flex', flexGrow: 1, marginTop: '80px' }}>
        {/* Sidebar starts from 80px height */}
        <Drawer
          variant="persistent"
          anchor="left"
          open={sidebarOpen}
        ...
        <Box component="main" sx={{ flexGrow: 1, p: 3, transition: 'margin 0.3s', marginLeft: sidebarOpen ? '250px' : '0' }}>
          ...
          <Grid container spacing={2} sx={{ marginBottom: 2 }}>
            <Grid item xs={12} md={4}>
              <CardComponent icon={<img src="/icon.png" alt="Icon" />} title="Total Warehouses" value="12" imagePath="/Home.png" />
            </Grid>
            <Grid item xs={12} md={4}>
              <CardComponent icon={<img src="/icon.png" alt="Icon" />} title="1st Warehouse in Purchase" value="w116-Main Branch" imagePath="/S.png" />
            </Grid>
            <Grid item xs={12} md={4}>
              <CardComponent icon={<img src="/icon.png" alt="Icon" />} title="1st Warehouse in Sales" value="w112-Main Branch" imagePath="/card.png" />
            </Grid>
          </Grid>
            ...
            <Grid container spacing={0} >
              <Grid item md={5} container direction="column" >
                <Grid item>
                  ...
                  <Typography variant="h6" sx={{ fontWeight: "bold" }}>MONTH
                    <span style={{ color: "#007bff" }}> at </span>
                    ALL WAREHOUSES
                  </Typography>
                </Grid>

                {/* كرت المنتج تحت العنوان */}
                <Grid item sx={{ mt: 2 }}>
                  <ProductCard
                    rank={2}
                    imageUrl="/Shose1.png"
              ...
              {/* العمود الأيمن: كرت منتج كبير فوق وكرت صغير تحته */}
